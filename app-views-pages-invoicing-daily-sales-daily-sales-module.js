...
/***/ "./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.scss":
/*!******************************************************************************************************!*\
  !*** ./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.scss ***!
  \******************************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3ZpZXdzL3BhZ2VzL2ludm9pY2luZy9kYWlseS1zYWxlcy9jcmVhdGUtZGFpbHktc2FsZS9jcmVhdGUtZGFpbHktc2FsZS5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.ts":
/*!****************************************************************************************************!*\
  !*** ./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.ts ***!
  \****************************************************************************************************/
/*! exports provided: CreateDailySaleComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateDailySaleComponent", function() { return CreateDailySaleComponent; });
...
/* harmony import */ var _patients_create_visit_create_visit_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../patients/create-visit/create-visit.component */ "./src/app/views/pages/patients/create-visit/create-visit.component.ts");
/* harmony import */ var angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! angular-slickgrid */ "./node_modules/angular-slickgrid/fesm5/angular-slickgrid.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../../helpers */ "./src/helpers.ts");
...
var customQtyFormatter = function (row, cell, value, columnDef, dataContext, grid) {
    return "<span class=\"kt-badge " + (value > 0 ? 'kt-badge--success' : 'kt-badge--danger') + " kt-badge--md\">" + value + "</span>";
};
var CreateDailySaleComponent = /** @class */ (function () {
    function CreateDailySaleComponent(patientService, layoutUtilsService, mService, modalService, activeModal, data, datePipe, zone, router, settingsService) {
    ...
    CreateDailySaleComponent.prototype.angularGridReady = function (angularGrid) {
        this.angularGrid = angularGrid;
        this.dataView = angularGrid.dataView;
        this.grid = angularGrid.slickGrid;
        this.gridService = angularGrid.gridService;
    };
    CreateDailySaleComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dailySale = new _core_application__WEBPACK_IMPORTED_MODULE_2__["DailySale"]();
        this.initGrid();
        this.paymentsTypes = JSON.parse(localStorage.getItem('PaymentType'));
        this.dailySale.payment_type_id = 1;
        this.date = new Date();
        this.dateStruct = { day: this.date.getDate(), month: this.date.getMonth() + 1, year: this.date.getFullYear() };
    ...
    CreateDailySaleComponent.prototype.initGrid = function () {
        var _this = this;
        this.columnDefinitions = [
            {
                ...
                formatter: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["Formatters"].deleteIcon,
                minWidth: 30,
                maxWidth: 30,
            ...
            },
            {
                ...
                sortable: true,
                resizable: true,
                type: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["FieldType"].string,
                editor: {
                    model: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["Editors"].text
                },
                onCellChange: function (e, args) {
                    var updateItem = _this.angularGrid.gridService.getDataItemByRowIndex(args.row);
                    var result;
                    _this.mService.getProductByCode(args.dataContext.product_code).subscribe(function (res) { return result = res['data']; }, function (err) { return _this.layoutUtilsService.showActionNotification('Produit avec ce code n\'existe pas', _core_base_crud__WEBPACK_IMPORTED_MODULE_3__["MessageType"].Delete, 5000, true, true); }, function () {
                        if (result != null) {
                            updateItem.description = result['description'];
                            updateItem.unit_price = result['unit_price'];
                            updateItem.total_price = result['unit_price'];
                            updateItem.product_id = result['id'];
                            updateItem.qty_in_inventory = result['qty_in_inventory'];
                            _this.angularGrid.gridService.updateItem(updateItem);
                            _this.calculateTotals();
                            _this.getProductNomenclature(result['id']);
                            //this.addNewItem();
                        }
                        else {
                            _this.layoutUtilsService.showActionNotification('Produit avec ce code n\'existe pas', _core_base_crud__WEBPACK_IMPORTED_MODULE_3__["MessageType"].Delete, 5000, true, true);
                        }
                    });
                }
            },
            {
                ...
                field: 'product_id',
                excludeFromHeaderMenu: true,
                formatter: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["Formatters"].infoIcon,
                minWidth: 30,
                maxWidth: 30,
                onCellClick: function (e, args) {
            ...
            {
                id: 'qty_in_inventory', name: 'Qte Disponible', field: 'qty_in_inventory',
                sortable: true,
                resizable: true,
                formatter: customQtyFormatter,
            },
            {
                id: 'serial_number', name: 'N° Serie', field: 'serial_number',
                sortable: true,
                resizable: true,
                width: 130,
                type: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["FieldType"].string,
            ...
            {
                id: 'unit_price', name: 'Prix U', field: 'unit_price',
                sortable: true,
                resizable: true,
                type: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["FieldType"].number,
                editor: {
                    model: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["Editors"].text
                },
                onCellChange: function (e, args) {
                    var updateItem = _this.angularGrid.gridService.getDataItemByRowIndex(args.row);
                    updateItem.total_price = args.dataContext.quantity * args.dataContext.unit_price;
                    _this.angularGrid.gridService.updateItem(updateItem);
                    _this.calculateTotals();
                }
            },
            {
                id: 'quantity', name: 'QTE', field: 'quantity',
                sortable: true,
                width: 50,
                type: angular_slickgrid__WEBPACK_IMPORTED_MODULE_8__["FieldType"].number,
                editor: {
            ...
            },
            {
                ...
                onCellChange: function (e, args) {
                    var updateItem = _this.angularGrid.gridService.getDataItemByRowIndex(args.row);
                    updateItem.total_price = (args.dataContext.quantity * args.dataContext.unit_price) * (args.dataContext.discount / 100);
                    _this.angularGrid.gridService.updateItem(updateItem);
                    _this.calculateTotals();
                }
            },
    ...
    CreateDailySaleComponent.prototype.calculateTotals = function () {
        var sum = 0;
        for (var i = 0; i < this.dataset.length; i++) {
            sum += Number(this.dataset[i].total_price);
        }
        this.totalHt = sum;
        this.totalTtc = sum;
        this.total = this.totalTtc;
    };
    CreateDailySaleComponent.prototype.getProductNomenclature = function (productId) {
        var _this = this;
        var result;
        this.mService.getProductNomenclature(productId).subscribe(function (res) { return result = res; }, function (err) { return console.log(err); }, function () {
            result.forEach(function (element) {
                var newId = _this.dataset.length;
                var newItem = {
                    id: newId,
                    product_code: element['child_product']['product_code'],
                    description: element['child_product']['description'],
                    serial_number: '',
                    unit_price: element['child_product']['unit_price'],
                    product_id: element['child_product_id'],
                    quantity: element['child_quantity'],
                    discount: null,
                    total_price: element['child_product']['unit_price'] * element['child_quantity'],
                    qty_in_inventory: element['qty_in_inventory']
                };
    ...
    CreateDailySaleComponent.prototype.addNewItem = function () {
    ...
    CreateDailySaleComponent.prototype.getPatient = function () {
        var _this = this;
        var result;
    ...
    CreateDailySaleComponent.prototype.selectPatient = function () {
        this.modalService.open(_patients_create_visit_create_visit_component__WEBPACK_IMPORTED_MODULE_7__["PatientsListModalComponent"], { size: 'lg' });
    };
    CreateDailySaleComponent.prototype.getPatientByCode = function () {
        var _this = this;
        var result;
    ...
    CreateDailySaleComponent.prototype.addDailySale = function () {
        var _this = this;
        this.dailySale.patient_id = this.patient_id;
        this.dailySale.date = this.dateStruct['year'] + '/' + this.dateStruct['month'] + "/" + this.dateStruct['day'];
        this.dailySale.total_price_ht = this.totalHt;
        this.dailySale.created_ip_address = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().local_ip;
        this.dailySale.last_updated_ip_address = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().local_ip;
        this.dailySale.created_user_id = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().user_id;
        this.dailySale.last_modified_user_id = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().user_id;
        for (var i = 0; i < this.dataset.length; i++) {
            var item = {};
            item['line_number'] = i;
            item['daily_sale_id'] = null;
            item['product_id'] = this.dataset[i].product_id;
            item['serial_number'] = this.dataset[i].serial_number;
            item['quantity'] = this.dataset[i].quantity;
            item['total_price'] = this.dataset[i].total_price;
            item['discount'] = this.dataset[i].discount;
            item['created_ip_address'] = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().local_ip;
            item['last_updated_ip_address'] = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().local_ip;
            item['created_user_id'] = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().user_id;
            item['last_modified_user_id'] = Object(_helpers__WEBPACK_IMPORTED_MODULE_10__["getRequiredFields"])().user_id;
            this.details.push(item);
        }
        var message = "La vente journaliere ajout\u00E9e avec succ\u00E9s.";
        var result;
        this.mService.addDailySale({ daily_sale: this.dailySale, details: this.details, delivery_form: this.df }).subscribe(function (res) { return result = res; }, function (err) {
    ...
    CreateDailySaleComponent.prototype.printInvoice = function (dailySale) {
        var tableContent = "";
        for (var i = 0; i < this.dataset.length; i++) {
            var s = "\n       <tr>\n          <td>" + (i + 1) + "</td> <!-- Don't remove this column as it's needed for the row commands -->\n          <td>" + this.dataset[i]['product_code'] + "</td>\n          <td>" + this.dataset[i]['description'] + "</td>\n          <td>" + this.dataset[i]['quantity'] + "</td>\n          <td>" + this.dataset[i]['unit_price'] + "</td>\n          <td>" + this.dataset[i]['total_price'] + "</td>\n        </tr>\n      ";
            tableContent = tableContent + s;
        }
        var clientInfo;
        if (dailySale.patient_id != null) {
            clientInfo = "\n      <span>Client</span>\n        <div>\n          <span class=\"bold\">" + this.patient_name + "</span>\n        </div>\n  \n        <div>\n          <span>" + dailySale.patient.address + "</span>\n        </div>\n  \n        <div>\n          <span>{dailySale.patient.wilaya.code_wilaya}</span>\n        </div>\n  \n        <div>\n          <span>" + dailySale.patient.mobile_phone_number_1 + "</span>\n        </div>\n  \n        <div>\n          <span>{dailySale.patient.social_security_number}</span>\n        </div>\n      ";
        }
        else {
    ...
    CreateDailySaleComponent.prototype.productGridReady = function (angularGrid) {
    ...
    CreateDailySaleComponent.prototype.saveProductCode = function () {
        var _this = this;
        ...
        updateItem.unit_price = selected.unit_price;
        updateItem.total_price = selected.unit_price * updateItem.quantity;
        var result;
        this.mService.getProductByCode(selected.product_code).subscribe(function (res) { return result = res['data']; }, function (err) { return _this.layoutUtilsService.showActionNotification('Produit avec ce code n\'existe pas', _core_base_crud__WEBPACK_IMPORTED_MODULE_3__["MessageType"].Delete, 5000, true, true); }, function () {
            if (result != null) {
                updateItem.qty_in_inventory = result['qty_in_inventory'];
            }
            else {
            ...
            _this.calculateTotals();
            _this.angularGrid.gridService.updateDataGridItem(updateItem);
            _this.getProductNomenclature(selected.id);
            _this.modalService.dismissAll('Close click');
        });
    };
    CreateDailySaleComponent.ctorParameters = function () { return [
        ...
        { type: _core_application__WEBPACK_IMPORTED_MODULE_2__["InvoicingService"] },
    ...
    CreateDailySaleComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'kt-create-daily-sale',
            template: __webpack_require__(/*! raw-loader!./create-daily-sale.component.html */ "./node_modules/raw-loader/index.js!./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.html"),
            styles: [__webpack_require__(/*! ./create-daily-sale.component.scss */ "./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_core_application__WEBPACK_IMPORTED_MODULE_2__["PatientsService"],
            ...
            _core_application__WEBPACK_IMPORTED_MODULE_2__["InvoicingService"],
            ...
            _core_application__WEBPACK_IMPORTED_MODULE_2__["SettingsService"]])
    ], CreateDailySaleComponent);
    return CreateDailySaleComponent;
}());
...
/***/ "./src/app/views/pages/invoicing/daily-sales/daily-sales.component.scss":
/*!******************************************************************************!*\
  !*** ./src/app/views/pages/invoicing/daily-sales/daily-sales.component.scss ***!
  \******************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3ZpZXdzL3BhZ2VzL2ludm9pY2luZy9kYWlseS1zYWxlcy9kYWlseS1zYWxlcy5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/views/pages/invoicing/daily-sales/daily-sales.component.ts":
/*!****************************************************************************!*\
  !*** ./src/app/views/pages/invoicing/daily-sales/daily-sales.component.ts ***!
  \****************************************************************************/
/*! exports provided: DailySalesComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DailySalesComponent", function() { return DailySalesComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DailySalesComponent = /** @class */ (function () {
    ...
    DailySalesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'kt-daily-sales',
            template: __webpack_require__(/*! raw-loader!./daily-sales.component.html */ "./node_modules/raw-loader/index.js!./src/app/views/pages/invoicing/daily-sales/daily-sales.component.html"),
            styles: [__webpack_require__(/*! ./daily-sales.component.scss */ "./src/app/views/pages/invoicing/daily-sales/daily-sales.component.scss")]
        }),
...
/***/ "./src/app/views/pages/invoicing/daily-sales/daily-sales.module.ts":
/*!*************************************************************************!*\
  !*** ./src/app/views/pages/invoicing/daily-sales/daily-sales.module.ts ***!
  \*************************************************************************/
/*! exports provided: DailySalesModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DailySalesModule", function() { return DailySalesModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _create_daily_sale_create_daily_sale_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./create-daily-sale/create-daily-sale.component */ "./src/app/views/pages/invoicing/daily-sales/create-daily-sale/create-daily-sale.component.ts");
/* harmony import */ var _daily_sales_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./daily-sales.component */ "./src/app/views/pages/invoicing/daily-sales/daily-sales.component.ts");
...
var routes = [
    {
        path: '',
        component: _daily_sales_component__WEBPACK_IMPORTED_MODULE_14__["DailySalesComponent"],
        children: [
            {
                path: '',
                redirectTo: 'create-daily-sale',
                pathMatch: 'full'
            },
            {
                path: 'create-daily-sale',
                component: _create_daily_sale_create_daily_sale_component__WEBPACK_IMPORTED_MODULE_13__["CreateDailySaleComponent"]
            }
        ]
    }
];
var DailySalesModule = /** @class */ (function () {
    function DailySalesModule() {
    }
    DailySalesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            exports: [],
            providers: [_core_application__WEBPACK_IMPORTED_MODULE_9__["SettingsService"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbActiveModal"], _core_application__WEBPACK_IMPORTED_MODULE_9__["DataSharingService"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["DatePipe"], _core_application__WEBPACK_IMPORTED_MODULE_9__["InvoicingService"], _core_application__WEBPACK_IMPORTED_MODULE_9__["PatientsService"], _core_application__WEBPACK_IMPORTED_MODULE_9__["DoctorsService"]],
            entryComponents: [],
            declarations: [_create_daily_sale_create_daily_sale_component__WEBPACK_IMPORTED_MODULE_13__["CreateDailySaleComponent"], _daily_sales_component__WEBPACK_IMPORTED_MODULE_14__["DailySalesComponent"]]
        })
    ], DailySalesModule);
...
//# sourceMappingURL=app-views-pages-invoicing-daily-sales-daily-sales-module.js.map